...
// export const updateProfile = async (req, res) => {
//   try {
//     const { fullname, email, phoneNumber, bio, resume } = req.body;
//     const file = req.file;
...
//   try {
//     const { fullname, email, phoneNumber, bio, skills } = req.body;
//     const profilePhotoFile = req.file; // This is the profile photo
//     const resumeFile = req.files?.resume?.[0]; // This is the resume
...
export const updateProfile = async (req, res) => {
  try {
    const { fullname, email, phoneNumber, bio, skills } = req.body;
    const profilePhotoFile = req.files?.file?.[0]; // Changed from req.file to req.files.file[0]
    const resumeFile = req.files?.resume?.[0];
