  ...
  try {
    ...
    const updateFields = {
      ...
      'profile.skills': req.body.skills 
        ...
        : user.profile.skills,
      'profile.resumeUrl': req.body.resumeUrl || user.profile.resumeUrl,
      'profile.resumeOriginalName': req.body.resumeOriginalName || user.profile.resumeOriginalName || "Resume"
    };
