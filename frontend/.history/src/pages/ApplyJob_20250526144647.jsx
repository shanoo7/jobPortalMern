...
export const ApplyJob = ({ job, user, applied }) => {
  ...
  const getButtonColor = () => {
    ...
    if (hasApplied && buttonClicked) return "bg-red-500 hover:bg-red-600";
    if (hasApplied) return "bg-green-500 hover:bg-green-600";
    return "bg-primary hover:bg-primary/90"; // default
  };

  const getButtonText = () => {
    if (loading) return "Applying...";
    if (hasApplied && buttonClicked) return "You've already applied";
