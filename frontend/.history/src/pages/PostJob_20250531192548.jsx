...
export default function PostJob() {
  ...
  const {
    ...
    defaultValues: {
      ...
      logo: "https://www.google.com/imgres?q=google&imgurl=https%3A%2F%2Fsearchengineland.com%2Fwp-content%2Fseloads%2F2015%2F12%2Fgoogle-amp-fast-speed-travel-ss-1920.jpg&imgrefurl=https%3A%2F%2Fsearchengineland.com%2Fgoogle-dropped-google-instant-search-279674&docid=jZo3IQfO3ipiXM&tbnid=ccmLBDI62icT0M&vet=12ahUKEwiMopTP9sWNAxXNxzgGHUspO7MQM3oECCkQAA..i&w=1920&h=1080&hcb=2&ved=2ahUKEwiMopTP9sWNAxXNxzgGHUspO7MQM3oECCkQAA"
    }
  });
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {/* Job Description */}
        <div>
          <Textarea placeholder="Job Description*" {...register("description")} rows={4} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <Input type="number" placeholder="Experience (Years)*" {...register("experienceLevel")} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <Input type="number" placeholder="Positions Available*" {...register("position")} />
