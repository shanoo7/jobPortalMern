...
const JobListing = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      {loading && <div className="flex justify-center mt-8"><BarLoader width={"100%"} color="#36d7b7" /></div>}
      {/* {error && <p className="text-center text-red-500">Failed to load jobs: {error}</p>} */}

      {error && (
  <div className="text-center mt-4 text-red-600 bg-red-100 border border-red-300 px-4 py-2 rounded-md max-w-md mx-auto">
