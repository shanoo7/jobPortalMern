          ...
          {allAdminJobs.map((job) => (
            ...
            >
              ...
              <div className="mt-4 md:mt-0 flex flex-wrap gap-2">
                ...
                <Button className="cursor-pointer rounded" onClick={() => handleEdit(job)}>Edit</Button>
                <Button className="cursor-pointer rounded" variant="destructive" onClick={() => handleDelete(job)}>Delete</Button>
                <Button className="cursor-pointer rounded" onClick={() => handleApplications(job)}>View Applicants</Button>
              </div>
            </div>
          ))}
        </div>
