...
//                   {user?.role === "student" && formData.skills && 
...
function AccountManagementModal({ user, onClose, onUpdate }) {
  ...
  if (profilePhotoFile) {
    formPayload.append('file', profilePhotoFile); // Must match Multer config
  }
  if (resumeFile) {
    formPayload.append('resume', resumeFile); // Must match Multer config
  }
