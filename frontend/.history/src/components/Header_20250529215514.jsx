...
function Header() {
  // ... (keep all your existing Header component code exactly as is)
}
...
function AccountManagementModal({ user, onClose, onUpdate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Append all fields including skills
    formPayload.append('fullname', formData.fullname);
    formPayload.append('email', formData.email);
    formPayload.append('bio', formData.bio);
    formPayload.append('skills', formData.skills);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 p-4">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          {/* ... (keep existing modal header code) ... */}
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-2/3">
              {isEditing ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  {/* ... (keep existing name/email/bio fields) ... */}
                ...
                <div className="space-y-4">
                  {/* ... (keep existing view mode fields) ... */}
