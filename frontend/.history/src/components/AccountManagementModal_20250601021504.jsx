...
export function AccountManagementModal({ user, onClose, onUpdate }) {
    ...
    return (
        <div className="fixed inset-0 bg-amber-50 text-lg flex items-center justify-center bg-black bg-opacity-50 z-50 p-4" onClick={onClose}>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    {user?.role === "student" && (
                                        <div className="space-y-2">
                                            ...
                                            <Label htmlFor="resumeName">Resume Display Name</Label>
                                            <Input
                                                id="resumeName"
                                                name="resumeName"
