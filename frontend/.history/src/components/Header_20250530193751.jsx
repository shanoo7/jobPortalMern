...
const getSafeDownloadUrl = (resumeUrl, originalName) => {
  if (!resumeUrl || !originalName) return "";
...
<a
  href={getSafeDownloadUrl(user.profile.resume, user.profile.resumeOriginalName)}
  target="_blank"
  rel="noopener noreferrer"
  className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600"
>
