...
export const ApplicationCard = ({ application }) => {
  console.log(application.status)
   console.log("a",application.applicant?.email)
  // console.log("my applicant is", applicant)
  console.log("Full applicant data:", applicant.fullname, applicant.email);
      ...
      <div className="flex justify-between items-center">
        <Badge className={getStatusColor(application.status)}>
          ...
          {applicant?.role === "recruiter" ? (
            <span className="capitalize">{applicant.email}</span>
          ) : (
