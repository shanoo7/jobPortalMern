...
//                   {user?.role === "recruiter"  && <Link to="/my-jobs" className="flex items-center gap-2">
//                     <BriefcaseBusiness size={16} /> My Jobs
//                   </Link>}
                  
//                 </DropdownMenuItem>
//                  <DropdownMenuItem asChild>
//                   {user?.role === "student" && <Link to="/student-profile-jobs" className="flex items-center gap-2">
//                     <BriefcaseBusiness size={16} /> My Jobs
//                   </Link>}
...
const handleFileUpload = (e) => {
  ...
  return (
    <div 
      className="fixed inset-0 text-2xl flex items-center justify-center bg-black bg-opacity-50 z-50 p-4"
      onClick={onClose}
    >
      <div 
